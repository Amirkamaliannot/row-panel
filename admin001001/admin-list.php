    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-12 align-self-center text-right">
                <h3 class="text-primary"><?= $lang['managers']; ?></h3></div>
            <div class="col-md-12 align-self-center text-right">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)"><?= $lang['managers']; ?></a></li>
                </ol>
            </div>
            <!-- ----------- end breadcrumb ------------------------------------------------------------------------ -->
        ...
        <div class="container-fluid">
            ...
            <!-- ----------- add button ---------------------------------------------------------------------------- -->
            <div class="row">
                <a class="add-user mb-2" href="<?= $main_url ?>"> <?= $lang['add_manager'] ?>  <i class="fas fa-plus"></i></a>
            </div>
            <!-- ----------- add button ---------------------------------------------------------------------------- -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive m-t-5">
                                <table id="example23" class="display nowrap table table-hover table-striped"
                                    ...
                                    <thead>
                                    <tr>
                                        <th class="text-center"><?= $lang['row']; ?></th>
                                        <th class="text-center"><?= $lang['name']; ?></th>
                                        <th class="text-center"><?= $lang['last_name']; ?> </th>
                                        <th class="text-center"><?= $lang['user_name']; ?> </th>
                                        <th class="text-center"><?= $lang['access_level']; ?></th></th>
                                        <th class="text-center"><?= $lang['last_visit']; ?></th></th>
                                        <th class="text-center"><?= $lang['status'] ?></th>
                                        <th class="text-center"><?= $lang['operation'] ?></th>
                                    </tr>
                                    </thead>
                                    ...
                                    <? while ($row = $result->fetch_object()) { ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <?= ($row->access) ? $lang['general_manager'] : $lang['does_not_have'] ?>
                                            </td>

                                            <td class="text-center">
                                                <?= ($row->last_login) ? $action->time_to_shamsi($row->last_login) : $lang['failure_to_enter']; ?>
                                            </td>
